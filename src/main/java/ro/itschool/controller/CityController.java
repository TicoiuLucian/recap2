...
public class CityController {
    ...
    public ResponseEntity<City> getCityByName(
            ...
            @RequestParam boolean includeCountry) throws CityNotFoundException {
        return new ResponseEntity<>(cityService.findByName(cityName, includeCountry), HttpStatus.OK);
    }
